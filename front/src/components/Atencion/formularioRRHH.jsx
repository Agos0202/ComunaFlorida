...
function FormularioRRHH() {
  ...
  const generarPDF = (turnoData) => {
    ...
    doc.setFontSize(20);
    doc.text("TURNO DE ATENCION - AREA RECURSOS HUMANO", 20, 40);
 ...
 const limpiarFormulario = () => {
  ...
  return (
    <div>
      <h1 className="h1">SOLICITA TU TURNO PARA EL AREA DE RECURSOS HUMANOS</h1>
