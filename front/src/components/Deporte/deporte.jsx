  ...
  return (
    <div>
      ...
      <div>
        ...
        <button className="boton-formulario" onClick={() => mostrarFormulario(<Formulario />)}>HAZ CLICK AQUÍ PARA INSCRIBIRTE A HOCKEY</button>
        <button className="boton-formulario"  onClick={() => mostrarFormulario(<FormularioBasquet />)}>HAZ CLICK AQUÍ PARA INSCRIBIRTE A BASQUET</button>
        <button className="boton-formulario"  onClick={() => mostrarFormulario(<FormularioVoley />)}>HAZ CLICK AQUÍ PARA INSCRIBIRTE A VOLEY</button>
      </div>
